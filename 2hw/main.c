//У меня ошибка сегментирования, все никак не пойму где она и как ее исправить. Потратил на эту прогу 8 часов, в общем, я надеюсь, вы поможете мне и укажите на ошибку
#include <stdio.h>
#include <unistd.h>
#include <stdlib.h>
#include <string.h>
